...
export async function executeGraphQL<TData, TVariables>(
  ...
  // @salesforce/sdk-data >=1.135 takes a single GraphQLRequest object
  // ({ query, variables, operationName }); the scaffold was generated
  // against the older two-arg (query, variables) signature.
